...
const Terms: React.FC = () => {
  return (
    <div className="terms-container">
      ...
      <p className="date">Esta política de condiciones de uso es válida a partir de Junio de 2023.</p>
      <p className="intro">
        TÉRMINOS Y CONDICIONES — market facil<br />
        market facil, persona jurídica de derecho privado describe, a través de este documento, las normas de uso del sitio 
        <a href="https://www.marketfacil.com" target="_blank" rel="noopener noreferrer"> https://www.marketfacil.com </a>
        y de cualquier otro sitio web, tienda o aplicación operada por el titular.
      </p>
      <p>
      ...
      <h2 className="section-title">Sección 2 - Adhesión junto con la política de privacidad</h2>
      <p>
        El uso de este sitio web implica la adhesión a estas Condiciones de Uso y a la versión más actualizada de la Política de Privacidad de market facil.
      </p>
      <h2 className="section-title">Sección 3 - Condiciones de acceso</h2>
      <p>
        En general, el acceso al sitio web de market facil es gratuito y no requiere registro previo.
      </p>
      <p>
      ...
      <p>
        Algunas partes de este sitio web ofrecen al usuario la opción de publicar comentarios en determinadas áreas. market facil no consiente la publicación de contenidos de carácter discriminatorio, ofensivo o ilícito, o que infrinjan los derechos de autor o cualquier otro derecho de terceros.
      </p>
      <p>
        La publicación de cualquier contenido por parte del usuario de este sitio web, incluidos los mensajes y comentarios, implica una licencia no exclusiva, irrevocable e irreversible para su uso, reproducción y publicación por parte de market facil en su sitio web, plataformas de internet y aplicaciones, o incluso en otras plataformas, sin ninguna restricción o limitación.
      </p>
      ...
      <p>
        Todos los elementos de market facil son propiedad intelectual de la misma o de sus licenciantes. Estos términos o el uso del sitio web no le otorgan ninguna licencia o derecho de uso de los derechos de propiedad intelectual de market facil o de cualquier tercero.
      </p>
      <h2 className="section-title">Sección 6 - Enlaces a sitios web de terceros</h2>
      <p>
      ...
      <p>
        La totalidad del sitio web o cada una de sus secciones podrá ser cerrada, suspendida o interrumpida unilateralmente por market facil, en cualquier momento y sin previo aviso.
      </p>
      <h2 className="section-title">Sección 8 - Datos personales</h2>
      <p>
        Durante el uso de este sitio web, ciertos datos personales serán recogidos y procesados por market facil y/o los Socios. Las normas relativas al tratamiento de los datos personales de market facil están estipuladas en la Política de Privacidad.
      </p>
      <h2 className="section-title">Sección 9 - Contacto</h2>
      <p>
        Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros por correo electrónico MarketFacil@outloock.com.
      </p>
    </div>
  );
};
