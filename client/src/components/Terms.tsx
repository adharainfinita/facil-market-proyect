...
const Terms: React.FC = () => {
  return (
    <div>
Esta política de condiciones de uso es válida a partir del Jun 2023.
TÉRMINOS Y CONDICIONES — market facil
market facil, persona jurídica de derecho privado describe, a través de este documento, las normas de uso del sitio https://www.marketfacil.com y de cualquier otro sitio web, tienda o aplicación operada por el titular.
...
Sección 9 - Contacto
Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros por correo electrónico hectorcardoso18@outlook.com.
    </div>
