...
import { filterProductsByCategory, filterProductsByUser, 
	filterProductsByLocation, orderProducts } from "../redux/features/productSlice";
  ...
  const users = useSelector((state: RootState) => state.user.users);
	...
	<h3 className="filter-title">FILTRAR</h3>
		<label htmlFor="forCategory">Por categoría:</label>
			<select name="forCategory" className="filter-select" 
		...
		<label htmlFor="forUser">Por usuario:</label>
			<select name="forUser" className="filter-select" onChange={handleProductFilter}>
		...
		<label htmlFor="forLocation">Por locación:</label>
						<select name="forLocation" className="filter-select" onChange={handleProductFilter}>
							<option value="All">Default</option>
	...
	<select name="forPrice" className="filter-select" onChange={handleOrderProduct}>
	<option value="All">Default</option>
          <option value="MAX">Precio más alto</option>
          <option value="MIN">Precio más bajo</option>
	</select>
	<label htmlFor="forName">Por nombre:</label>
	<select name="forName" className="filter-select" onChange={handleOrderProduct}>
	<option value="All">Default</option>
