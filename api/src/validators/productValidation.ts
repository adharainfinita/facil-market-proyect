...
export const productCreate = [
	...
	check("categoryID").isInt().withMessage("El ID de Categoria debe ser números y enteros."),

	check("userID").isInt().withMessage("El ID de usuario debe ser números y enteros."),
